...
export function AppProvider({ children }) {
  ...
  async function loadAll() {
    try {
      ...
      const appDb = rowsToDb({ orders: orders || [], riders: riders || [], payments: payments || [], expenses: expenses || [], riderExpenses: riderExpenses || [], remittances: remittances || [], deliveryFees: deliveryFees || [], loans: loans || [], inventory: inventory || [], vendorPayments: vendorPayments || [], inventoryHistory: inventoryHistory || [] });
