...
import { OperationSupportViews, DeliveryCoordinatorViews } from './views/RiderManagerViews';
...
function AppContent() {
  ...
  function renderContent() {
    ...
    if (session.role === 'operation-support') return <OperationSupportViews tabId={activeTab} />;
